...
def main():
    ...
    parser.add_argument('--tracker', type=str, default='mlgt', help='name of tracking method')
    ...
    parser.add_argument('--seq', type=str, default='GOT-10k_Test_000091', help='sequence number or name')
