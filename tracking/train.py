...
def parse_args():
    ...
    # For train
    parser.add_argument('--script', type=str, default='mlgt', help='training script name')
...
def main():
    args = parse_args()
    if args.mode == 'single':
        train_cmd = 'python D:/2023/MLGT/lib/train/run_training.py --script %s --config %s --save_dir %s --use_lmdb %d ' \
